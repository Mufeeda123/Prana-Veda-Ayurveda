  ...
  return (
    <Layout>
      <div className="bg-stone-800 text-stone-200 py-20 text-center">
        ...
        <p className="text-lg">We are here to help you on your wellness journey.</p>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-stone-600 mb-8">
                Whether you want to book a consultation, ask about a treatment, or just say hello, we'd love to hear from you.
              </p>
            </div>
            ...
            <div className="grid gap-6">
              <div className="flex items-start gap-4 p-6 bg-cream rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-stone-700 block mb-2">{CONTACT_PHONE}</p>
                  <a 
                    href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Namaste, I would like to book an appointment.')}`}
              ...
              <div className="flex items-start gap-4 p-6 bg-cream rounded-lg">
                ...
                <div>
                  ...
                  <a href={`mailto:${CONTACT_EMAIL}`} className="text-stone-700 hover:text-primary transition-colors">
                    {CONTACT_EMAIL}
                  </a>
                </div>
              </div>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" id="name" className="w-full px-4 py-2 border border-stone-300 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Your Name" />
                  </div>
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-stone-700 mb-1">Phone</label>
                    <input type="tel" id="phone" className="w-full px-4 py-2 border border-stone-300 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Mobile Number" />
                  </div>
                </div>
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-stone-700 mb-1">Message</label>
                  <textarea id="message" rows={4} className="w-full px-4 py-2 border border-stone-300 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="How can we help you?"></textarea>
                </div>
                <button type="submit" className="w-full bg-primary text-white font-bold py-3 px-4 rounded-md hover:bg-green-900 transition-colors">
                  Send Inquiry
                </button>
